...
export const embedList$ = observable<EmbedInfo[]>([
  ...
  },
  {
    id: 'C',
    iframeSrc:
      'https://codepen.io/Thisisntme/embed/Qxqgvv?default-tab=html%2Cresult&theme-id=dark&editable=true',
...
export const creatorList$ = observable<CreatorInfo[]>([
  {
    ...
    name: 'Ludwig',
    iconSrc:
      'https://yt3.googleusercontent.com/ytc/AGIKgqPzDF0P9mISeSG4jx6bKj7TdWDp22qjsfuo5wb97w=s176-c-k-c0x00ffffff-no-rj',
    isLive: true,
  ...
  },
  {
    ...
    name: 'Stanz',
    iconSrc:
      'https://static-cdn.jtvnw.net/jtv_user_pictures/42edd801-5b7e-470d-9bdc-47eca00ae114-profile_image-70x70.png',
    isLive: true,
  ...
  },
  {
    id: '4',
    name: 'Mogswamp',
    iconSrc: 'https://i.imgur.com/OJGRjxV.png',
    isLive: false,
    platform: Platform.youtube,
    order: 1,
  },
